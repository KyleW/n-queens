 ...
 */
    ...
    hasMajorDiagonalConflictAt: function(majorDiagonalColumnIndexAtFirstRow, y){
      ...
      // turn diagonal into array
      for ( var i = y; i < n; i ++){
        diag.push(this.get(y)[x]);
        x++;
        y++;
      }

      // check the array
      return this.checker(diag); // fixme
    },
    ...
    hasMinorDiagonalConflictAt: function(minorDiagonalColumnIndexAtFirstRow, y){
      var n = this.attributes.n;
